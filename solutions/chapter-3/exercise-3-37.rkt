...
;---
;Here 'c+', 'c*', etc. are the "constraint" versions of the arithmetic operations. For
...
;defining the "constraint" versions of the arithmetic operations
;---
(define (c+ x y)
  (let ((z (make-connector)))
    (adder x y z)
...
;expression-oriented 'celsius-fahrenheit-converter'
;---
(define (celsius-fahrenheit-converter x)
  (c+ (c* (c/ (cv 9) (cv 5))
          x)
