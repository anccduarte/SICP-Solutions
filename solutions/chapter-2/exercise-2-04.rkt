...
;using the substitution model for a random pair
;(check if (car-v2 (cons-v2 x y)) yields x; similar reasoning for 'cdr-v2')
;---
;1. (define p (cons-v2 1 2))
;2. (car-v2 p)
;3. (p (lambda (a b) a))
;4. ((lambda (m) (m 1 2)) (lambda (a b) a))
;5. ((lambda (a b) a) 1 2)
;6. 1
