...
;some previously implemented procedures (points and segments)
;---
...
;------------------------------------------------------------------------------------------
;1st REPRESENTATION -> rectangle in terms of segments
...
;define 'dot-product' (helper of orthogonal)
;---
...
(let ((s1 (make-segment (make-point 0 0) (make-point 2 0)))
  ...
  (let ((rectangle (make-rectangle-v1 s1 s2)))
    (display "width-v1 = ") (display (width-rectangle-v1 rectangle))
    (newline)
    (display "height-v1 = ") (display (height-rectangle-v1 rectangle))
    (newline)))


;------------------------------------------------------------------------------------------
;2nd REPRESENTATION -> rectangle in terms of width, height, origin and angle
...
(let ((rectangle (make-rectangle-v2 2 4 (make-point 0 0) 45)))
  (display "width-v2 = ") (display (width-rectangle-v2 rectangle))
  (newline)
  (display "height-v2 = ") (display (height-rectangle-v2 rectangle))
  (newline))


;------------------------------------------------------------------------------------------
;IMPLEMENTATION OF PERIMETER AND AREA (using both representations)
;perimeter: 'perimeter-v1' / 'perimeter-v2'
;area: 'area-v1' / 'area-v2'
;------------------------------------------------------------------------------------------
