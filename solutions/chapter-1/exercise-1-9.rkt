...
;iterative process -> there is no chain of deferred operations in this case; moreover,
...
;recursive process -> a chain of deferred increments is built, meaning that the state
